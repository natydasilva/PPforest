...
pprf.crab 
```
`PPforest` print a summary result from the model with the consfusion matrix information and the oob-error rate in a similar way randomForest packages does.
