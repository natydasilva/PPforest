...
|ppf_avg_pptree_imp| Computes a global importance measure for a PPforest object, average importance measure for a pptree over all the trees.| 
...
<!--  m =  10, PPmethod = 'LDA', size.p = 0.6, parallel = TRUE,cores=2 )  -->
