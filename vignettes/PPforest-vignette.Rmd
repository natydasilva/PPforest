...
`parallel_dat`, `ppf_oob_error`, `proxy_plot` and `vote_viz` are functions to visualize some of the main diagnostics in `PPforest`. The main diagnostics are; vote matrix, proximity matrix, importance variable measure and error rat.
